...
public class OrderSummaryActivityTest {
    ...
    @Rule public IntentsTestRule<OrderSummaryActivity> mActivityRule = new IntentsTestRule<>(
    ...
    public void clickSendEmailButton_SendsEmail() {
        ...
        String msg = getInstrumentation().getTargetContext().getString(R.string.email_message);
        intended(allOf(
                hasAction(Intent.ACTION_SENDTO),
                hasExtra(Intent.EXTRA_TEXT, msg)));
    }
}